...
int main()
{
        ...
        -> std::optional<Hit>
    {
        ...
        {
            auto const rti = rayTriangleIntersection(ray, triangle[i], range);
        ...
        */
        ...
        (
                ...
                -> std::optional<Hit>
            {
                ...
                auto const rti = rayTriangleIntersection(ray, tri, range);
                return happened(rti)
                    ? std::optional{Hit{u32(i), rti.t}}
                    : std::nullopt;
            }),
            std::nullopt,
